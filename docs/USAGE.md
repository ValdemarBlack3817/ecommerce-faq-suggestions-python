...
The single thin client is the seam: add a method that calls another `/v1/...` route (e.g. one of embeddings, ai.rerank, vector.collection.create, vector.upsert, vector.query) and reuse it from your own code.
